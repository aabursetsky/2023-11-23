...
def personal_sum(numbers):
    ...
    try:
        ...
        incorrect_data += 1
    return result, incorrect_data                              # кортеж (сумма чисел,
                                                               # количество не корректных значений)

def calculate_average(numbers):
    result = personal_sum(numbers)
    try:
        average_result = result[0] / (len(numbers) - result[1]) # сумма / кол. корректных значений
